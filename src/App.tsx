...
const PLATFORM_LOGOS: Record<string, string> = {
  ...
  'google-review': `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 64"><rect width="56" height="64" rx="8" fill="white"/><path d="M28 8a16 16 0 00-5.6 31l.1-7.7h-3.8v-5.5h3.8V22c0-3.8 2.3-5.8 5.6-5.8 1.6 0 3 .1 3 .1v3.7h-1.7c-1.9 0-2.4 1.2-2.4 2.3v2.5h4.2l-.7 5.5H27v7.7A16 16 0 0028 8z" fill="none"/><path d="M28 6C18.1 6 10 13.4 10 22.5c0 4.2 1.7 8 4.4 10.9l-1.2 7.6 7.8-2.5c2.2 1 4.6 1.5 7 1.5 9.9 0 18-7.4 18-16.5S37.9 6 28 6z" fill="none"/><g transform="translate(8,2)"><path d="M35.6 16H20v6.5h9c-.8 3.5-4.5 6-9 6-5 0-9.2-4.2-9.2-9.2S15 10 20 10c2.2 0 4.2.8 5.7 2.2l4.6-4.6A14.8 14.8 0 0020 3C11.2 3 4 10.2 4 19s7.2 16 16 16 16-7.2 16-16c0-1-.1-2-.4-3z" fill="#4285F4"/><path d="M5.3 11.5l5.3 3.9C12 12.5 15.6 10 20 10c2.2 0 4.2.8 5.7 2.2l4.6-4.6A14.8 14.8 0 0020 3C14.1 3 9 6.2 5.3 11.5z" fill="#EA4335"/><path d="M20 35c3.8 0 7.3-1.3 10-3.6l-4.8-4c-1.5 1-3.5 1.7-5.6 1.7-4.4 0-8.2-3-9.5-7.1l-5.2 4A16 16 0 0020 35z" fill="#34A853"/><path d="M5.1 22.1l5.2-4c-.3-1-.5-2-.5-3.1s.2-2.1.5-3.1l-5.2-4A15.8 15.8 0 004 19c0 2.6.6 5 1.7 7.2z" fill="#FBBC05"/></g><g transform="translate(6,42)">' +
    [0,1,2,3,4].map(i => `<polygon points="${4+i*10},0 ${5.2+i*10},3.5 ${9+i*10},3.8 ${6.2+i*10},6.2 ${7+i*10},10 ${4+i*10},7.8 ${1+i*10},10 ${1.8+i*10},6.2 ${-1+i*10},3.8 ${2.8+i*10},3.5" fill="#FBBC05"/>`).join('') +
    '</g></svg>')}`,
