...
const PLATFORM_LOGOS: Record<string, string> = {
  ...
  'google-review': `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><rect width="48" height="48" rx="12" fill="#fff"/><path d="M43.6 20H24v8h11.3c-1.6 4.3-5.7 7.4-11.3 7.4-6.2 0-11.3-5.1-11.3-11.4S17.8 12.6 24 12.6c2.7 0 5.2 1 7.1 2.7l5.7-5.7A19.5 19.5 0 0024 4C12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.4-.1-2.7-.4-4z" fill="#4285F4"/><path d="M6.3 14.7l6.6 4.8C14.5 16 18.9 13 24 13c2.7 0 5.2 1 7.1 2.7l5.7-5.7A19.5 19.5 0 0024 4c-7.3 0-13.7 4-17.1 10l-.6.7z" fill="#EA4335"/><path d="M24 44c5 0 9.5-1.7 13-4.7l-6-5c-1.9 1.3-4.3 2.1-7 2.1-5.5 0-10.2-3.7-11.8-8.8l-6.5 5A20 20 0 0024 44z" fill="#34A853"/><path d="M6.2 27.6l6.5-5c-.4-1.2-.7-2.5-.7-3.9 0-1.3.2-2.6.6-3.8l-6.5-5A19.8 19.8 0 004 24c0 3.2.8 6.3 2.2 9.1z" fill="#FBBC05"/></svg>')}`,
