...
export interface Translations {
  ...
  descCode39: string;
  descItf14: string;
  barcodeEingabe: string;
  barcodeFreitext: string;
  pruefziffer: string;
  pruefzifferBerechnet: string;
  pruefzifferGueltig: string;
  pruefzifferUngueltig: string;
  pruefzifferErklaerung: string;
  pruefzifferFormel: string;
  pruefzifferSchritt1: string;
  pruefzifferSchritt2: string;
  pruefzifferSchritt3: string;
  pruefzifferSchritt4: string;
  pruefzifferValidierung: string;
  barcodeVorschau: string;
  balkenfarbe: string;
  ...
  barcodePng: string;
  barcodeSvg: string;
  ziffernEingeben: string;
  nurZiffern: string;
  zuVieleZeichen: string;
  zuWenigeZeichen: string;
  zeichenUebrig: string;
  kompletteNummer: string;
}
